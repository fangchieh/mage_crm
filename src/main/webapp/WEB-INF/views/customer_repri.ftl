...
<div id="p" class="easyui-panel" title="客户流失信息" style="height:250px">
    <table cellspacing="8px">
        ...
        <tr>
            <td>客户名称：</td>
            <td><input type="text" id="customerName" name="cusName" readonly="readonly"
                       value="${(customerLoss['cusName'])!}"/></td>
            <td></td>
            <td>客户编号</td>
            <td><input type="text" id="cusNo" name="cusNo" readonly="readonly" value="${(customerLoss['cusNo'])!}"/>
            </td>
        </tr>
        <tr>
            <td>客户经理：</td>
            <td><input type="text" id="cusManager" name="cusManager" readonly="readonly"
                       value="${(customerLoss['cusManager'])!}"/></td>
            <td></td>
            <td>上次下单时间：</td>
            <td><input type="text" id="lastOrderTime" name="lastOrderTime" readonly="readonly"
                       value="${(customerLoss['lastOrderTime'])!}"/></td>
        </tr>
        <tr>
            <td>确认流失时间：</td>
            <td><input type="text" id="confirmLossTime" name="confirmLossTime" readonly="readonly"
                       value="${(customerLoss['confirmLossTime'])!}"/></td>
            <td colspan="3"></td>
        </tr>
        <tr>
            <td>流失原因：</td>
            <td colspan="4"><input type="text" id="lossReason" name="lossReason" style="width: 420px"
                                   readonly="readonly" value="${(customerLoss['lossReason'])!}"/></td>
        </tr>
    </table>
</div>
<br/>
...
<div id="toolbar">
    <a href="javascript:$('#dg').edatagrid('addRow')" class="easyui-linkbutton" iconCls="icon-add"
       plain="true">添加暂缓措施</a>
